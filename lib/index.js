 ...
 * @property {string} headingTextTemplate The template for each series heading text where {{seriesTagName}} is the placeholder for each series tag name. {@link https://pinjasaur.github.io/templater.js/|templater.js} is the templating library used.
...
export function SeriesDisplay(ghostContentApi) {
    ...
    const DefaultBuildOptions = {
        ...
        headingTextTemplate: 'Other Posts in {{seriesTagName}}',
