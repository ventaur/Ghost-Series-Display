    ...
    async function buildSeriesInfoFragment(document, options) {
        ...
        for (const [ seriesTag, posts ] of postsGroupedBySeriesTags) {
            ...
            for (const post of posts) {
                ...
                // TODO: Change this to use the slug and call the settings endpoint to get the site URL.
                // * const rootPath = settings.url;
                // * const currentSlug = stripSlash(document.location.href.replace(rootPath, ''));
