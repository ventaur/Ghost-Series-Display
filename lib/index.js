...
export function SeriesDisplay(ghostContentApi) {
    ...
    function findSeriesTagSlugs(document, seriesTagSlugPrefix = DefaultSeriesTagSlugPrefix) {
        ...
        return bodyClasses
            .filter(c => 
                c.startsWith(HtmlTagClassNamePrefix + seriesTagSlugPrefix) ||
                c.startsWith(HtmlTagClassNamePrefix + HashTagSlugPrefix + seriesTagSlugPrefix)
            )
