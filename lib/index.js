...
export function SeriesDisplay(ghostContentApi) {
    ...
    /** @type {import("./buildSeriesInfoFragmentFromPosts").BuildSeriesInfoOptions} */
     ...
     * @param {import("./buildSeriesInfoFragmentFromPosts").BuildSeriesInfoOptions} options The options for building.
