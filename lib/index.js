...
import { ElementInsertionPosition, insertNodeRelativeToElement } from './insertNodeRelativeToElement.js';
...
export function SeriesDisplay(ghostContentApi) {
    ...
    async function buildSeriesInfoFragment(document, options) {
        ...
        const { currentPostUrl, hideSinglePostSeries, comingSoonText, seriesTagSlugs } = normailizeBuildOptions(options, () => findSeriesTagSlugsInDocument(document));
    ...
    function insertSeriesInfo(document, seriesInfoFragment, insertions) {
